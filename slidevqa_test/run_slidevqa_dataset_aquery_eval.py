...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run SlideVQA deck-level direct aquery evaluation sequentially. "
    ...
    parser.add_argument(
        ...
        help="RAGAnything/LightRAG query mode passed to worker aquery calls.",
    )
    parser.add_argument(
        "--vlm-enhanced",
...
def run_deck_worker(
    *,
    ...
    worker_script = SCRIPT_DIR / "run_first_sample_aquery_eval.py"
    cmd = [
        sys.executable,
        str(worker_script),
        "--parquet",
    ...
    cmd.append("--vlm-enhanced" if args.vlm_enhanced else "--no-vlm-enhanced")
