"""Supervisor process for WhatsApp runtime."""
...
WHATSAPP_SUPERVISOR_HOOKS = SupervisorHooks(
    channel_display_name="WhatsApp",
    worker_module="client.whatsapp.worker",
...
def supervisor_main() -> int:
    ...
    return supervisor_main_core(hooks=WHATSAPP_SUPERVISOR_HOOKS)
