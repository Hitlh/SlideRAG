...
from client.feishu_runtime_supervisor import supervisor_main
from client.feishu_runtime_worker import worker_main


def build_cli_args() -> argparse.Namespace:
    """Parse CLI args for backward-compatible runtime entrypoint."""
    parser = argparse.ArgumentParser(description="Feishu runtime launcher")
